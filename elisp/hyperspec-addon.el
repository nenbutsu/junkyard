;;; hyperspe-addon.el --- Add additional entries to CL HyperSpec lookup table
...
;; You can look up symbols specified in CLHS (Common Lisp HyperSpec) with
;; hyperspec.el from within Emacs. hyperspec-addon.el adds extra entries
;; to hyperspec.el.
;;
...
;; characters (e.g. "~C: Character"), reader macro characters (e.g. "#+"),
;; loop keywords (e.g. "loop:collect"), MOP symbols
;; (e.g. "class-direct-slots"), CLHS glossary entries (e.g. "{lisp image}")
;; and so on.
;;
...
;;
;; You might want to use mcomplete.el with it, or entry names are too long
;; to enter.
...
(defvar hyperspec-mop-page
  "http://www.lisp.org/mop/"
  ;;"file:///home/yuji/archives/mop/www.lisp.org/mop/"
  )

(defvar clisp-doc
  "file:///usr/share/doc/clisp/doc/")

(defun hyperspec-default-entry ()
...
(defun common-lisp-hyperspec (symbol-name)
  "View the documentation on SYMBOL-NAME from the Common Lisp HyperSpec, et al."
  (interactive (list (let ((default (hyperspec-default-entry)))
                       (completing-read
                        (concat "Look up symbol in Common Lisp HyperSpec"
                                (when default (format " (%s)" default))
                                ": ")
                        common-lisp-hyperspec-symbols #'boundp
                        t nil
                        'common-lisp-hyperspec-history default))))
  (maplist (lambda (entry)
             (browse-url (if (stringp (car entry))
...
(mapcar (lambda (entry)
          (let ((symbol (intern (downcase (first entry))
                                common-lisp-hyperspec-symbols)))
            (if (boundp symbol)
                (unless (member (second entry) (symbol-value symbol))
                  (push (second entry) (symbol-value symbol)))
                (set symbol (cdr entry)))
            ))
        '(;; Top page of Common Lisp Hyper Spec 
          ("" "../Front/index.htm")
          ...
          ;; MOP
          ("mop" (hyperspec-mop-page "index.html"))
          
          ("add-dependent" (hyperspec-mop-page "dictionary.html#add-dependent"))
          ("add-direct-method"
           (hyperspec-mop-page "dictionary.html#add-direct-method"))
          ("add-direct-subclass"
           (hyperspec-mop-page "dictionary.html#add-direct-subclass"))
          ("add-method" (hyperspec-mop-page "dictionary.html#add-method"))
          ("allocate-instance"
           (hyperspec-mop-page "dictionary.html#allocate-instance"))

          ("class-... " (hyperspec-mop-page "dictionary.html#class-"))
          ("class-default-initargs"
           (hyperspec-mop-page "dictionary.html#class-mo-readers"))
          ...
          ("class-finalized-p"
           (hyperspec-mop-page "dictionary.html#class-mo-readers"))
          ("class-name" (hyperspec-mop-page "dictionary.html#class-mo-readers"))
          ...
          ("compute-applicable-methods"
           (hyperspec-mop-page "dictionary.html#compute-applicable-methods"))
          ("compute-applicable-methods-using-classes"
           (hyperspec-mop-page
            "dictionary.html#compute-applicable-methods-using-classes"))
          ("compute-class-precedence-list"
           (hyperspec-mop-page "dictionary.html#compute-class-precedence-list"))
          ("compute-default-initargs"
           (hyperspec-mop-page "dictionary.html#compute-default-initargs"))
          ("compute-discriminating-function"
           (hyperspec-mop-page "dictionary.html#compute-discriminating-function"))
          ("compute-effective-method"
           (hyperspec-mop-page "dictionary.html#compute-effective-method"))
          ("compute-effective-slot-definition"
           (hyperspec-mop-page
            "dictionary.html#compute-effective-slot-definition"))
          ("compute-slots" (hyperspec-mop-page "dictionary.html#compute-slots"))
          ("direct-slot-definition-class"
           (hyperspec-mop-page "dictionary.html#direct-slot-definition-class"))
          ("effective-slot-definition-class"
           (hyperspec-mop-page "dictionary.html#effective-slot-definition-class"))
          ("ensure-class" (hyperspec-mop-page "dictionary.html#ensure-class"))
          ("ensure-class-using-class"
           (hyperspec-mop-page "dictionary.html#ensure-class-using-class"))
          ("ensure-generic-function"
           (hyperspec-mop-page "dictionary.html#ensure-generic-function"))
          ("ensure-generic-function-using-class"
           (hyperspec-mop-page
            "dictionary.html#ensure-generic-function-using-class"))
          ("eql-specializer-object"
           (hyperspec-mop-page "dictionary.html#eql-specializer-object"))
          ("extract-lambda-list"
           (hyperspec-mop-page "dictionary.html#extract-lambda-list"))
          ("extract-specializer-names"
           (hyperspec-mop-page "dictionary.html#extract-specializer-names"))
          ("finalize-inheritance"
           (hyperspec-mop-page "dictionary.html#finalize-inheritance"))
          ("find-method-combination"
           (hyperspec-mop-page "dictionary.html#find-method-combination"))
          ("funcallable-standard-instance-access"
           (hyperspec-mop-page
            "dictionary.html#funcallable-standard-instance-access"))

          ("generic-function-..."
           (hyperspec-mop-page "dictionary.html#generic-function-"))
          ("generic-function-argument-precedence-order"
           (hyperspec-mop-page "dictionary.html#gf-mo-readers"))
          ...
          ("Initialization of Class Metaobjects"
           (hyperspec-mop-page "dictionary.html#class-mo-init"))
          ("Initialization of Generic Function Metaobjects"
           (hyperspec-mop-page "dictionary.html#gf-mo-init"))
          ("Initialization of Method Metaobjects"
           (hyperspec-mop-page "dictionary.html#Initialization"))
          ("Initialization of Slot Definition Metaobjects"
           (hyperspec-mop-page "dictionary.html#Initialization"))

          ("intern-eql-specializer"
           (hyperspec-mop-page "dictionary.html#intern-eql-specializer"))
          ("make-instance" (hyperspec-mop-page "dictionary.html#make-instance"))
          ("make-method-lambda"
           (hyperspec-mop-page "dictionary.html#make-method-lambda"))
          ("map-dependents" (hyperspec-mop-page "dictionary.html#map-dependents"))

          ("method-..." (hyperspec-mop-page "dictionary.html#method-"))
          ("method-function"
           (hyperspec-mop-page "dictionary.html#method-mo-readers"))
          ...
          ("Readers for Slot Definition Metaobjects"
           (hyperspec-mop-page "dictionary.html#slotd-mo-readers"))
          
          ("reader-method-class"
           (hyperspec-mop-page "dictionary.html#reader-method-class"))
          ("remove-dependent"
           (hyperspec-mop-page "dictionary.html#remove-dependent"))
          ("remove-direct-method"
           (hyperspec-mop-page "dictionary.html#remove-direct-method"))
          ("remove-direct-subclass"
           (hyperspec-mop-page "dictionary.html#remove-direct-subclass"))
          ("remove-method" (hyperspec-mop-page "dictionary.html#remove-method"))
          ("set-funcallable-instance-function"
           (hyperspec-mop-page "dictionary.html#set-funcallable-instance-function"))
          ("(setf class-name)"
           (hyperspec-mop-page "dictionary.html#(setf class-name)"))
          ("(setf generic-function-name)"
           (hyperspec-mop-page "dictionary.html#(setf generic-function-name)"))
          ("(setf slot-value-using-class)"
           (hyperspec-mop-page "dictionary.html#(setf slot-value-using-class)"))
          ("slot-boundp-using-class"
           (hyperspec-mop-page "dictionary.html#slot-boundp-using-class"))

          ("slot-definition-..."
           (hyperspec-mop-page "dictionary.html#slot-definition-"))
          ...
          ("slot-makunbound-using-class"
           (hyperspec-mop-page "dictionary.html#slot-makunbound-using-class"))
          ("slot-value-using-class"
           (hyperspec-mop-page "dictionary.html#slot-value-using-class"))
          ("specializer-direct-generic-functions"
           (hyperspec-mop-page "dictionary.html#specializer-direct-generic-functions"))
          ("specializer-direct-methods"
           (hyperspec-mop-page "dictionary.html#specializer-direct-methods"))
          ("standard-instance-access"
           (hyperspec-mop-page "dictionary.html#standard-instance-access"))
          ("update-dependent"
           (hyperspec-mop-page "dictionary.html#update-dependent"))
          ("validate-superclass"
           (hyperspec-mop-page "dictionary.html#validate-superclass"))
          ("writer-method-class"
           (hyperspec-mop-page "dictionary.html#writer-method-class"))

          ;; clisp
          ("ext:cd" (clisp-doc "impnotes.html#cd"))
          ("clisp" (clisp-doc "impnotes.html"))
          ("clisp:open" (clisp-doc "impnotes.html#open"))
...
(provide 'hyperspe-addon)

;;; hyperspe-addon.el ends here
