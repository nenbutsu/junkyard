...
(mapc #'(lambda (entry)
      ...
      '(("clisp(1)" (cl-lookup-clisp-root "clisp.html"))
        ...
        ("ext:quit" (cl-lookup-clisp-root "impnotes.html#quit"))
        ("ext:bye" (cl-lookup-clisp-root "impnotes.html#quit"))
        ...
        ("ext:execute" (cl-lookup-clisp-root "impnotes.html#exec"))
        ("ext:shell" (cl-lookup-clisp-root "impnotes.html#exec"))
        ("ext:run-shell-command" (cl-lookup-clisp-root "impnotes.html#run-prog"))
        ("ext:run-program" (cl-lookup-clisp-root "impnotes.html#run-prog"))
        ("ext:make-pipe-input-stream" (cl-lookup-clisp-root "impnotes.html#pipe"))
        ("ext:make-pipe-output-stream" (cl-lookup-clisp-root "impnotes.html#pipe"))
        ("ext:make-pipe-io-stream" (cl-lookup-clisp-root "impnotes.html#pipe"))
        ("ext:with-output-to-printer"
         (cl-lookup-clisp-root "impnotes.html#hardcopy"))
        ("ext:getenv" (cl-lookup-clisp-root "impnotes.html#getenv"))
        ("ext:make-xterm-io-stream"
         (cl-lookup-clisp-root "impnotes.html#separate-io"))
        ("ext:*args*" (cl-lookup-clisp-root "impnotes.html#script-exec"))
